...
class NotificationConfig(YotiSerializable):
    ...
    def __init__(self, auth_token, endpoint, auth_type, topics=None):
        """
    ...
    def auth_type(self):
        """
        The authentication type that notification will use to
        authenticate itself.
...
class NotificationConfigBuilder(object):
    ...
    def build(self):
        ...
        """
        return NotificationConfig(self.__auth_token, self.__endpoint, self.__auth_type, self.__topics)
